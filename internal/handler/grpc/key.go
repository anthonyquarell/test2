...
func (h *Key) CreateOrder(ctx context.Context, req *electronic_product_v1.CreateOrderReq) (*electronic_product_v1.CreateOrderRep, error) {
	result, err := h.keyUsecase.ActivateByProvider(ctx, req.ProductId, req.CustomerPhone)
	if err != nil {
		return nil, err
	}
