...
func EncodeKeyGetResponse(v *model.Main) *e_product_v1.KeyGetRep {
	response := &e_product_v1.KeyGetRep{}

	if v != nil {
		response.Key = EncodeKeyMain(v, 0)
	}
...
func EncodeActivateRep(v *model.Main) *e_product_v1.KeyActivateRep {
	if v == nil {
		return nil
	}
