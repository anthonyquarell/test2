...
import (
	...
	serviceModel "github.com/mechta-market/e-product/internal/service/provider/comportal/model"
...
func DecodeSearchRep(product CatalogProduct) *serviceModel.Product {
	return &serviceModel.Product{
...
func EncodeOrderRequest(req *serviceModel.OrderReq, catalogProduct CatalogProduct, ptid string) *OrderReq {
	return &OrderReq{
...
func DecodeOrderResponse(rep OrderRep) *serviceModel.OrderRep {
	...
	return &serviceModel.OrderRep{
		OrderID: &rep.Data.OrderID,
		ID:      &rep.Data.TransactionID,
		Value:   value,
		Link:    link,
	}
}
