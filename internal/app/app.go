...
func (a *App) Init() {
	...
	var cptService *serviceComportalP.Service
...

	{
		...
		if config.Conf.MegogoUrl != "" {
			...
			megogoService = serviceMegogoP.New(repo, keyService)
