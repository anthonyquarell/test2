...
import (
	...
	"github.com/mechta-market/e-product/internal/client/comportal"
...
func (o *St) AddRoute(dbName, uri, username, password string) {
...
func (o *St) Send(ctx context.Context, obj *comportal.SendReq) (_ []byte, finalError error) {
	...
	// auth
	if route.username != "" {
		req.SetBasicAuth(route.username, route.password)
	}
