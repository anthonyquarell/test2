...
func (_m *MdmServiceI) ListCatalog(ctx context.Context, providerID string) ([]*model.CatalogProduct, bool, error) {
	...
	var r0 []*model.CatalogProduct
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]*model.CatalogProduct, bool, error)); ok {
		return rf(ctx, providerID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []*model.CatalogProduct); ok {
		r0 = rf(ctx, providerID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.CatalogProduct)
		}
	}
